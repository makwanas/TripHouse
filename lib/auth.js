...
const admin = 'admin@businesses.com'
exports.admin = admin
...
const requireBusinessOwnerId = async (req, res, next) => {
    try {
        ...
        console.log(' -- Error:', err)
        res.status(500).send({
            error: 'Error fetching business.   Try again later.'
        })
    }
}
exports.requireBusinessOwnerId = requireBusinessOwnerId
